...
function addHealthData() {
    ...
    _node_modules_axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(uri, { bloodPressureUpper: bPUI, bloodPressureDown: bPDI, heartRate: hRI, temperature: tI, userId: uII, dateTimeInfo: dTII })
        .then(function (response) {
