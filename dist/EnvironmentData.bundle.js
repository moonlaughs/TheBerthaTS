...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/EnvironmentData.ts");
/******/ })
/************************************************************************/
/******/ ({
...
function addEnvData() {
    ...
    var uri = "https://thebertharestconsumer20181031102055.azurewebsites.net/api/environment";
    _node_modules_axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(uri, { oxygen: addOx, co2: addCo2, co: addCo, pm25: addPm25, pm10: addPm10, ozon: addOz, dustParticles: addDP, nitrogenDioxide: addND, sulphurDioxide: addSD, longitude: addLon, latitude: addLan, userId: addUI, dateTimeInfo: dTII })
        .then(function (response) {
...
/******/ });
//# sourceMappingURL=EnvironmentData.bundle.js.map